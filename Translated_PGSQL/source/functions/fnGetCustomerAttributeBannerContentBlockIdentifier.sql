...
WITH LatestTargetCustomerAttribute_CTE (customerattributebannerbundlecontentid, storeid, customerattributetypeid, customerattribute, daynumber) 
    ...
    INNER JOIN csn_notif_batch_dbo_tblplemaillists AS emailist  
    ON (bannercontent.storeid = emailist.storeid) 
    ...
    INNER JOIN dbo_tblcustomerattributestorestore AS customerattributestorestore  
    ON (bannercontent.storeid = customerattributestorestore.storeid 
